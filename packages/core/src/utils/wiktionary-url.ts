...
export const normalizeWiktionaryHeadword = (headword: string, targetLanguage: string, pos?: string | null): string => {
...
export const buildWiktionaryUrl = (headword: string, targetLanguage: string, pos?: string | null): string | null => {
