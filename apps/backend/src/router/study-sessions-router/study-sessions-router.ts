...
export const toStudySessionDto = (row: DbStudySessionWithSource) => ({
  ...
  contentSourceBackdropUrl: readMetaString(row.content_source_metadata, 'backdropUrl'),
  contentSourceStillUrl: readMetaString(row.content_source_metadata, 'stillUrl'),
  youtubeVideoId: readMetaString(row.content_source_metadata, 'youtubeVideoId'),
