...
export const EditableGrammarPanel = ({ card }: Props) => {
  const { t } = useLingui()
    ...
    <div className='border-t pt-3'>
      ...
      {open && (
        <div className='mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2'>
          ...
          <div>
            <Label className='text-xs'>{t`Display form (e.g. stress-marked)`}</Label>
            <Input
