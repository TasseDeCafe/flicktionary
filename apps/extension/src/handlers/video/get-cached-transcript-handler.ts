import type { Command, Message, GetCachedTranscriptMessage, GetCachedTranscriptResponse } from '@asbplayer-fork/common'
...
export default class GetCachedTranscriptHandler {
  ...
  private async _handleRequest(videoUrl: string, sendResponse: (r?: GetCachedTranscriptResponse) => void) {
    try {
