...
Canonical examples: `triage-list-view.tsx:200` and the `done` branch of `practice-session-view.tsx`. Avoid `Button` default size and avoid `md:w-auto` floats — full-width xl on mobile and desktop both.
